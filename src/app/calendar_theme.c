...
void calendar_theme_init(calendar_theme_t *theme)
{
    ...
    lv_style_set_text_color(&theme->inverse, lv_color_hex(0xf7f6ef));
    ...
    lv_style_set_text_color(&theme->today, lv_color_hex(0xf7f6ef));
